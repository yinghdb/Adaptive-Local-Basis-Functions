...
from src.dataset.sv1datamodule_albf import DataModule
...
def parse_args():
    ...
    parser.add_argument(
        '--vis_ckpt_path', type=str, default=None,
        help='trained encode checkpoint path')
    parser.add_argument(
...
def main():
    ...
    # lightning data
    data_module = DataModule(args, config.dataset, is_encode=False)

    # lightning module
    model = MisModule(config, encode_ckpt=args.vis_ckpt_path, pretrained_ckpt=args.ckpt_path)
